...
static const char * c2_debug_family_names[5] = { "nargin", "nargout", "quant_in",
  "nLev", "quant_out" };
...
static void initialize_c2_MASH_HDL(SFc2_MASH_HDLInstanceStruct *chartInstance);
static void initialize_params_c2_MASH_HDL(SFc2_MASH_HDLInstanceStruct
  *chartInstance);
static void enable_c2_MASH_HDL(SFc2_MASH_HDLInstanceStruct *chartInstance);
static void disable_c2_MASH_HDL(SFc2_MASH_HDLInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_MASH_HDL(SFc2_MASH_HDLInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_MASH_HDL(SFc2_MASH_HDLInstanceStruct
  *chartInstance);
static void set_sim_state_c2_MASH_HDL(SFc2_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c2_st);
static void finalize_c2_MASH_HDL(SFc2_MASH_HDLInstanceStruct *chartInstance);
static void sf_c2_MASH_HDL(SFc2_MASH_HDLInstanceStruct *chartInstance);
static void c2_chartstep_c2_MASH_HDL(SFc2_MASH_HDLInstanceStruct *chartInstance);
static void initSimStructsc2_MASH_HDL(SFc2_MASH_HDLInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static int64_T c2_emlrt_marshallIn(SFc2_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_b_emlrt_marshallIn(SFc2_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void c2_eml_fi_checkforconst(SFc2_MASH_HDLInstanceStruct *chartInstance);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int64_T c2_d_emlrt_marshallIn(SFc2_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c2_quant_out, const char_T *c2_identifier);
static int64_T c2_e_emlrt_marshallIn(SFc2_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_MASH_HDL, const char_T *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_MASH_HDLInstanceStruct *chartInstance);
...
static void initialize_c2_MASH_HDL(SFc2_MASH_HDLInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_MASH_HDL = 0U;
  ...
  *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_MASH_HDL;
  ...
  const mxArray *c2_st)
{
  ...
  *c2_quant_out = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 0)), "quant_out");
  chartInstance->c2_is_active_c2_MASH_HDL = c2_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 1)), "is_active_c2_MASH_HDL");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_MASH_HDL(chartInstance);
...
static void sf_c2_MASH_HDL(SFc2_MASH_HDLInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_MASH_HDL(chartInstance);
...
static void c2_chartstep_c2_MASH_HDL(SFc2_MASH_HDLInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 1U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_quant_in, 2U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_nLev, 3U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_quant_out, 4U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  int64_T c2_b_u;
  const mxArray *c2_b_y = NULL;
  SFc2_MASH_HDLInstanceStruct *chartInstance;
  chartInstance = (SFc2_MASH_HDLInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_MASH_HDL_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_b_is_active_c2_MASH_HDL, const char_T *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_MASH_HDL), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_MASH_HDL);
  return c2_y;
}
...
void sf_c2_MASH_HDL_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_MASH_HDL_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_MASH_HDL_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_MASH_HDL_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_MASH_HDL(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"quant_out\",},{M[8],M[0],T\"is_active_c2_MASH_HDL\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_MASH_HDL_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_MASH_HDLInstanceStruct *chartInstance;
    chartInstance = (SFc2_MASH_HDLInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c2_MASH_HDL(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_MASH_HDLInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_MASH_HDL((SFc2_MASH_HDLInstanceStruct*) chartInstanceVar);
  initialize_c2_MASH_HDL((SFc2_MASH_HDLInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_MASH_HDL(void *chartInstanceVar)
{
  enable_c2_MASH_HDL((SFc2_MASH_HDLInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_MASH_HDL(void *chartInstanceVar)
{
  disable_c2_MASH_HDL((SFc2_MASH_HDLInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_MASH_HDL(void *chartInstanceVar)
{
  sf_c2_MASH_HDL((SFc2_MASH_HDLInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_MASH_HDL(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_MASH_HDL((SFc2_MASH_HDLInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_MASH_HDL();/* state var info */
...
extern void sf_internal_set_sim_state_c2_MASH_HDL(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_MASH_HDL((SFc2_MASH_HDLInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_MASH_HDL(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_MASH_HDL(S);
}

static void sf_opaque_set_sim_state_c2_MASH_HDL(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_MASH_HDL(S, st);
}

static void sf_opaque_terminate_c2_MASH_HDL(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_MASH_HDLInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_MASH_HDL_optimization_info();
    }

    finalize_c2_MASH_HDL((SFc2_MASH_HDLInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_MASH_HDL((SFc2_MASH_HDLInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_MASH_HDL(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_MASH_HDL((SFc2_MASH_HDLInstanceStruct*)
      (((ChartInfoStruct *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_MASH_HDL(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_MASH_HDL(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_MASH_HDL(SimStruct *S)
{
  SFc2_MASH_HDLInstanceStruct *chartInstance;
  chartInstance = (SFc2_MASH_HDLInstanceStruct *)utMalloc(sizeof
    (SFc2_MASH_HDLInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_MASH_HDLInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_MASH_HDL;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_MASH_HDL;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_MASH_HDL;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_MASH_HDL;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_MASH_HDL;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_MASH_HDL;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_MASH_HDL;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_MASH_HDL;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_MASH_HDL;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_MASH_HDL;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_MASH_HDL;
...
void c2_MASH_HDL_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_MASH_HDL(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_MASH_HDL(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_MASH_HDL(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_MASH_HDL_method_dispatcher.\n"
