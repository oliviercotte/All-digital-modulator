...
static const char * c1_debug_family_names[5] = { "nargin", "nargout", "quant_in",
  "nLev", "quant_out" };
...
static void initialize_c1_MASH_HDL(SFc1_MASH_HDLInstanceStruct *chartInstance);
static void initialize_params_c1_MASH_HDL(SFc1_MASH_HDLInstanceStruct
  *chartInstance);
static void enable_c1_MASH_HDL(SFc1_MASH_HDLInstanceStruct *chartInstance);
static void disable_c1_MASH_HDL(SFc1_MASH_HDLInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_MASH_HDL(SFc1_MASH_HDLInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_MASH_HDL(SFc1_MASH_HDLInstanceStruct
  *chartInstance);
static void set_sim_state_c1_MASH_HDL(SFc1_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_MASH_HDL(SFc1_MASH_HDLInstanceStruct *chartInstance);
static void sf_c1_MASH_HDL(SFc1_MASH_HDLInstanceStruct *chartInstance);
static void c1_chartstep_c1_MASH_HDL(SFc1_MASH_HDLInstanceStruct *chartInstance);
static void initSimStructsc1_MASH_HDL(SFc1_MASH_HDLInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static int64_T c1_emlrt_marshallIn(SFc1_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_b_emlrt_marshallIn(SFc1_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static void c1_eml_fi_checkforconst(SFc1_MASH_HDLInstanceStruct *chartInstance);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int64_T c1_d_emlrt_marshallIn(SFc1_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c1_quant_out, const char_T *c1_identifier);
static int64_T c1_e_emlrt_marshallIn(SFc1_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_f_emlrt_marshallIn(SFc1_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_MASH_HDL, const char_T *c1_identifier);
static uint8_T c1_g_emlrt_marshallIn(SFc1_MASH_HDLInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_MASH_HDLInstanceStruct *chartInstance);
...
static void initialize_c1_MASH_HDL(SFc1_MASH_HDLInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_MASH_HDL = 0U;
  sf_mex_assign(&c1_b_eml_mx, sf_mex_call_debug("numerictype", 1U, 10U, 15,
    "WordLength", 6, 36.0, 15, "FractionLength", 6, 25.0, 15, "BinaryPoint", 6,
    25.0, 15, "Slope", 6, 2.9802322387695313E-8, 15, "FixedExponent", 6, -25.0),
                TRUE);
  ...
  *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_MASH_HDL;
  ...
  const mxArray *c1_st)
{
  ...
  *c1_quant_out = c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 0)), "quant_out");
  chartInstance->c1_is_active_c1_MASH_HDL = c1_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 1)), "is_active_c1_MASH_HDL");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_MASH_HDL(chartInstance);
...
static void sf_c1_MASH_HDL(SFc1_MASH_HDLInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_MASH_HDL(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_MASH_HDLMachineNumber_,
...
static void c1_chartstep_c1_MASH_HDL(SFc1_MASH_HDLInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 1U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_quant_in, 2U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_nLev, 3U, c1_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_quant_out, 4U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  int64_T c1_b_u;
  const mxArray *c1_b_y = NULL;
  SFc1_MASH_HDLInstanceStruct *chartInstance;
  chartInstance = (SFc1_MASH_HDLInstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId)
{
  ...
  sf_mex_assign(&c1_mxInt, sf_mex_call("simulinkarray", 1U, 1U, 14, sf_mex_dup
    (c1_mxFi)), FALSE);
  sf_mex_import(c1_parentId, sf_mex_dup(c1_mxInt), &c1_i0, 1, 8, 0U, 0, 0U, 0);
...
const mxArray *sf_c1_MASH_HDL_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId)
{
  ...
  sf_mex_assign(&c1_mxInt, sf_mex_call("simulinkarray", 1U, 1U, 14, sf_mex_dup
    (c1_mxFi)), FALSE);
  sf_mex_import(c1_parentId, sf_mex_dup(c1_mxInt), &c1_i2, 1, 8, 0U, 0, 0U, 0);
  sf_mex_destroy(&c1_mxFi);
  sf_mex_destroy(&c1_mxInt);
  c1_y = c1_i2;
  sf_mex_destroy(&c1_u);
  ...
  const mxArray *c1_b_is_active_c1_MASH_HDL, const char_T *c1_identifier)
{
  ...
  c1_y = c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_MASH_HDL), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_MASH_HDL);
  return c1_y;
}
...
void sf_c1_MASH_HDL_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2343434698U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2833795750U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(496551506U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(105759286U);
}

mxArray *sf_c1_MASH_HDL_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("w85xUEEInciWATeDJLkQpG");
...

  {
...

    {
...

      {
        ...
        mxSetField(mxFixpt,0,"exponent",mxCreateDoubleScalar(-25));
...
mxArray *sf_c1_MASH_HDL_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_MASH_HDL_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_MASH_HDL(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"quant_out\",},{M[8],M[0],T\"is_active_c1_MASH_HDL\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_MASH_HDL_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_MASH_HDLInstanceStruct *chartInstance;
    chartInstance = (SFc1_MASH_HDLInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_MASH_HDLMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_MASH_HDLMachineNumber_,
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,466,481,527,578);
        _SFD_SET_DATA_COMPILED_PROPS(0,SF_INT32,0,NULL,1,1,36,0,1,-25,0,
          (MexFcnForType)c1_d_sf_marshallOut,(MexInFcnForType)NULL);
        _SFD_SET_DATA_COMPILED_PROPS(1,SF_INT32,0,NULL,1,1,36,0,1,-25,0,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _MASH_HDLMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "8QKn2hCFeQKYZMRmLb0hgC";
}

static void sf_opaque_initialize_c1_MASH_HDL(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_MASH_HDLInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c1_MASH_HDL((SFc1_MASH_HDLInstanceStruct*) chartInstanceVar);
  initialize_c1_MASH_HDL((SFc1_MASH_HDLInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_MASH_HDL(void *chartInstanceVar)
{
  enable_c1_MASH_HDL((SFc1_MASH_HDLInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_MASH_HDL(void *chartInstanceVar)
{
  disable_c1_MASH_HDL((SFc1_MASH_HDLInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_MASH_HDL(void *chartInstanceVar)
{
  sf_c1_MASH_HDL((SFc1_MASH_HDLInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_MASH_HDL(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_MASH_HDL((SFc1_MASH_HDLInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_MASH_HDL();/* state var info */
...
extern void sf_internal_set_sim_state_c1_MASH_HDL(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_MASH_HDL((SFc1_MASH_HDLInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_MASH_HDL(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_MASH_HDL(S);
}

static void sf_opaque_set_sim_state_c1_MASH_HDL(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_MASH_HDL(S, st);
}

static void sf_opaque_terminate_c1_MASH_HDL(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_MASH_HDLInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_MASH_HDL_optimization_info();
    }

    finalize_c1_MASH_HDL((SFc1_MASH_HDLInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_MASH_HDL((SFc1_MASH_HDLInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_MASH_HDL(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_MASH_HDL((SFc1_MASH_HDLInstanceStruct*)
      (((ChartInfoStruct *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_MASH_HDL(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_MASH_HDL_optimization_info();
  ...
  ssSetChecksum0(S,(2603791425U));
  ssSetChecksum1(S,(2932216630U));
  ssSetChecksum2(S,(1801046551U));
  ssSetChecksum3(S,(2353286702U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_MASH_HDL(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_MASH_HDL(SimStruct *S)
{
  SFc1_MASH_HDLInstanceStruct *chartInstance;
  chartInstance = (SFc1_MASH_HDLInstanceStruct *)utMalloc(sizeof
    (SFc1_MASH_HDLInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_MASH_HDLInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_MASH_HDL;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_MASH_HDL;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_MASH_HDL;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_MASH_HDL;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_MASH_HDL;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_MASH_HDL;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_MASH_HDL;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_MASH_HDL;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_MASH_HDL;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_MASH_HDL;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_MASH_HDL;
...
void c1_MASH_HDL_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_MASH_HDL(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_MASH_HDL(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_MASH_HDL(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_MASH_HDL_method_dispatcher.\n"
