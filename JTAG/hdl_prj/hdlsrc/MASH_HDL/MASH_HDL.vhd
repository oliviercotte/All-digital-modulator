...
BEGIN
  u_MATLAB_Function : MATLAB_Function
    PORT MAP( quant_in => std_logic_vector(Modulator_input),  -- sfix36_En25
              nLev => Constant_out1,  -- double
              quant_out => Modulator_output_stage_1  -- sfix36_En25
              );

  u_MATLAB_Function1 : MATLAB_Function1
    PORT MAP( quant_in => std_logic_vector(Modulator_input_1),  -- sfix36_En25
              nLev => Constant1_out1,  -- double
              quant_out => Quantizer  -- sfix36_En25
              );
