...
xst -ifn xst.scr
move overclocking_generator_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\overclocking_generator_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc overclocking_generator_exdes.ucf overclocking_generator_exdes

echo 'Running map'
map -timing -pr b overclocking_generator_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm overclocking_generator_exdes -w routed.ncd routed.vhd
cd ..
