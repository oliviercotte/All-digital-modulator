...
xst -ifn xst.scr
move clocking_generator1_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clocking_generator1_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clocking_generator1_exdes.ucf clocking_generator1_exdes

echo 'Running map'
map -timing -pr b clocking_generator1_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clocking_generator1_exdes -w routed.ncd routed.vhd
cd ..
