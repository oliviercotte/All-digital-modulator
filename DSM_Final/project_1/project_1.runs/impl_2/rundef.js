...
ISEStep( "ngdbuild",
         "-intstyle ise -p xc7z045ffg900-3 -dd _ngo -uc \"all_digital_modulator.ucf\" \"all_digital_modulator.edf\"" );
ISEStep( "map",
         "-intstyle pa -w -pr b -timing -logic_opt on -register_duplication -ol high -xe n -mt on \"all_digital_modulator.ngd\"" );
ISEStep( "par",
